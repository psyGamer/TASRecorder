...
public unsafe partial struct AVChannelLayout_u {
    ...
    [FieldOffset(0)] public AVChannelCustom* @map;
}
...
public unsafe partial struct AVFilterContext {
    ...
    [Obsolete("unused")] public AVFilterCommand* @command_queue;

    /// <summary>enable expression string</summary>
    public byte* @enable_str;

    [Obsolete("unused")] public void* @enable;
    [Obsolete("unused")] public double* @var_values;
...
public unsafe partial struct AVOption_default_val {
    ...
    [FieldOffset(0)] public AVRational @q;

    /// <summary>Used for AV_OPT_TYPE_FLAG_ARRAY options. May be NULL.</summary>
    [FieldOffset(0)] public AVOptionArrayDef* @arr;
}
...
public unsafe partial struct AVStreamGroup_params {
    [FieldOffset(0)] public AVIAMFAudioElement* @iamf_audio_element;
    [FieldOffset(0)] public AVIAMFMixPresentation* @iamf_mix_presentation;
    [FieldOffset(0)] public AVStreamGroupTileGrid* @tile_grid;
    [FieldOffset(0)] public AVStreamGroupLCEVC* @lcevc;
}
